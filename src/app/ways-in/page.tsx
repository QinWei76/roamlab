    ...
    <main className="ways-visual-page">
      ...
      <section className="ways-visual-hero">
        ...
        <div className="ways-visual-hero-copy">
          <p className="ways-visual-kicker">
            WAYS IN
          </p>
          ...
          <p className="ways-visual-intro">
            Every adventure starts differently.
            Your way in changes what you carry,
            how you prepare and how far you can go.
          </p>
        </div>
      ...
      <section className="ways-visual-grid">
        ...
        {ways.map((way) => (
          ...
          >
            ...
            <span className="ways-card-number">
              {way.number}
            </span>

            <div className="ways-card-content">

              <p className="ways-card-eyebrow">
                {way.eyebrow}
              </p>

              <h2>{way.title}</h2>

              <p className="ways-card-description">
                {way.description}
              </p>
      ...
      <section className="ways-unsure">
        ...
        <div className="ways-unsure-number">
          05
        </div>
        ...
        <div className="ways-unsure-copy">
          ...
          <span>
            You don't need to know the route yet.
            Start with the experience you want and
            RoamLab will help you build the way in.
          </span>
