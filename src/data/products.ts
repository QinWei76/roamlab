export const products = {
  "roofnest-sparrow-xl": {
    ...
    recommendation:
      "Best for campers who want a fast and comfortable sleeping setup without building a permanent interior system.",
    features: [
  ...
  "exped-megamat-duo": {
    ...
    recommendation:
      "Great for travelers who want home-level sleeping comfort inside their vehicle.",
    features: [
